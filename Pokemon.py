...
class pokemon:
    ...
    def showdown(self, other):
        ...
        while (self.health > 0) and (other.health > 0):
            ...
            print(self.name, " did ", self.attack, " to ", other.name)
            ...
            print(other.name, " did ", other.attack, " to ", self.name)
...
if __name__ == '__main__':
    piph = int(input("insert the attack amount between 5 or 1 \n"))
    piplup = pokemon("Piplup", 389, 0.4, 5.2, piph, "Water", "Blue", 20)

    chart = int(input("insert the attack amount between 5 or 1 \n"))
